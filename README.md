...
docker build --build-arg D8_TARBALL_URL="<d8_build_url>" -t v8-poc .
...
- ✅ Exact V8/d8 version and operating system
- ✅ SHA-256 hash of test artifacts
- ✅ Console output and crash logs from disposable test environment
- ✅ Confirmation of successful read/write outside sandbox or crash
- ✅ Any mitigations or build flags that affect reproducibility
...
**Sensitivity:** 🔒 CONFIDENTIAL - SECURITY RESEARCH
