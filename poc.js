function wasmS128Const(f) {     // Write in little-endian order at offset 0.
  if (Array.isArray(f)) {
  ...
  if (arguments.length === 2) {
    ...
    throw new Error('S128Const needs an array of bytes, or two f64 values, or four f32 values');
  }
  return result;
}
...
let [wasmBrOnCast, wasmBrOnCastFail, wasmBrOnCastDesc, wasmBrOnCastDescFail] = (function() {
  return [
    (labelIdx, sourceType, targetType) => wasmBrOnCastImpl(labelIdx, sourceType, targetType, kExprBrOnCast),
    (labelIdx, sourceType, targetType) => wasmBrOnCastImpl(labelIdx, sourceType, targetType, kExprBrOnCastFail),
    (labelIdx, sourceType, targetType) => wasmBrOnCastImpl(labelIdx, sourceType, targetType, kExprBrOnCastDesc),
    (labelIdx, sourceType, targetType) => wasmBrOnCastImpl(labelIdx, sourceType, targetType, kExprBrOnCastDescFail),
  ];
